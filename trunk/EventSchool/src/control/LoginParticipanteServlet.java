 ...
 */
@WebServlet(name = "acessoParticipante", urlPatterns = { "/acessoParticipante" })
public class LoginParticipanteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoginParticipanteServlet() {
        super();
